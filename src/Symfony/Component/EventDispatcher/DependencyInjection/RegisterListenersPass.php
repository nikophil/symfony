...
class RegisterListenersPass implements CompilerPassInterface
{
    ...
    /**
     * $listenerClassesMap['listener_FQCN'][] => array{serviceId: string, method:string}.
     *
     * @var array<string, array{serviceId: string, method:string}>
     */
     ...
     */
    private function collectListeners(ContainerBuilder $container): iterable
    {
     ...
     * @return \Generator<string, list<ListenerDefinition>>
     */
    private function collectSubscribers(ContainerBuilder $container): iterable
    {
        $aliases = $this->getEventsAliases($container);
